...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
	...
	try {
				...
				if(request.getParameter("saveEdit") != null)
				{
					...
					PreparedStatement editSearch = con.prepareStatement("select id,name,password from users join customers using (id) where id=?");
					editSearch.setString(1,id);
					customers = editSearch.executeQuery();
					String oldName="",oldPassword="";
					while(customers.next())
					{
						oldName = customers.getString(2);
						oldPassword = customers.getString(3);
					}
				...
				if(request.getParameter("saveNew") != null)
				{
					...
					customers = searchStatement.executeQuery();
				...
				out.println(" <h3><FONT COLOR=blue> Current List of Customers: </font></h3>");
				...
				{
					out.print("<form action='manageCustomers.jsp'> <button type='submit' name ='addButton' class='btn'><i class='fa-solid fa-square-plus'>Add</i></button></form><br>");
				}
				
				// IF EDIT BUTTON WAS PRESSED
				if(request.getParameter("editButton") != null)
				{
					out.print("<h3> Edit a Customer:</h3>"
				...
				{
						out.print("<h3> Add a Customer:</h3>"
								 + "<form action='manageCustomers.jsp'>"
				...
				str = "select * from customers join users using(id)";
				customers = stmt.executeQuery(str);
			...
			//	List<String> customerIds = new ArrayList<String>();
				...
				while (customers.next()) {
					...
					out.print("<tr>");
					out.print("<td>");
					out.print("<form action='manageCustomers.jsp' >"
					...
					//display a column
					out.print("<td>");
					out.print(customers.getString("id"));
					out.print("</td>");
					//display a column
					out.print("<td>");
					...
					//display a column
					out.print("<td>");
					out.print(customers.getString("password"));
					out.print("</td>");
